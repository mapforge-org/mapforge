...
export class PolygonControl {
  constructor(_options) {
    ...
    this._container.innerHTML = `<button class="mapbox-gl-draw_ctrl-draw-btn mapbox-gl-draw_polygon" type="button" title="${window.__('Draw polygon (o)')}" aria-label="${window.__('Draw polygon')}" aria-pressed="false"></button>`
