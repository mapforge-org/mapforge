...
export class PolygonControl {
  constructor(_options) {
    ...
    this._container.innerHTML = '<button class="mapbox-gl-draw_ctrl-draw-btn mapbox-gl-draw_polygon" type="button" title="Draw polygon" aria-label="Draw polygon" aria-pressed="false"></button>'
