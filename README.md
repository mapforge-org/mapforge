...
Now, you can run the image with: `podman run -e SECRET_KEY_BASE=e3c9f2... -e DEVELOPER_LOGIN_ENABLED=true -e HTTP_PORT=3001 -e SSL=false --network=host ghcr.io/mapforge-org/mapforge:main`
