...
# From https://cdn.jsdelivr.net/npm/maplibre-gl@6.10.0/dist/
...
# render markdown
pin "marked", preload: false # @18.0.12
...
pin "@kurkle/color", to: "@kurkle--color.js", preload: false # @0.6.4
