...
pin "maplibre-gl", preload: false # @5.23.0
...
# render markdown
pin "marked", preload: false # @18.0.2
...
pin "swiper", to: "swiper-bundle.min.js", preload: false # @12.1.2
...
pin "@turf/projection", to: "@turf--projection.js", preload: false # @7.3.5
pin "@turf/clone", to: "@turf--clone.js", preload: false # @7.3.5
...
pin "@turf/along", to: "@turf--along.js", preload: false # @7.3.4
pin "@turf/bearing", to: "@turf--bearing.js", preload: false # @7.3.4
pin "@turf/destination", to: "@turf--destination.js", preload: false # @7.3.4
pin "@turf/length", to: "@turf--length.js", preload: false # @7.3.5
pin "@turf/area", to: "@turf--area.js", preload: false # @7.3.5
pin "@turf/buffer", to: "@turf--buffer.js", preload: false # @7.3.5
pin "@turf/bbox", to: "@turf--bbox.js", preload: false # @7.3.5
